...
class ApplicationMain {
	...
	public static function create ():Void {
		...
		urls.push ("assets/images/dngr_zone.png");
		types.push (lime.Assets.AssetType.IMAGE);
		
		
		urls.push ("assets/images/extream.png");
		types.push (lime.Assets.AssetType.IMAGE);
		...
		urls.push ("assets/images/letlow.png");
		types.push (lime.Assets.AssetType.IMAGE);
		
		
		urls.push ("assets/images/paddle.png");
		types.push (lime.Assets.AssetType.IMAGE);
		
		
		urls.push ("assets/images/paddle_cl.png");
		types.push (lime.Assets.AssetType.IMAGE);
		
		
		urls.push ("assets/images/paddle_dmg.png");
		types.push (lime.Assets.AssetType.IMAGE);
		
		
		urls.push ("assets/images/saysFulllow.png");
		types.push (lime.Assets.AssetType.IMAGE);
		
		
		urls.push ("assets/images/Wolv.png");
		types.push (lime.Assets.AssetType.IMAGE);
	...
	public static function main () {
		...
		config = {
			...
			build: "385",
			company: "HaxeFlixel",
			file: "WolverineHUG_arcade",
			fps: 60,
			name: "WolverineHUG_arcade",
			orientation: "",
